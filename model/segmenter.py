...
class CRISModified(nn.Module):
    def __init__(
        ...
        """
        Modified CRIS model to have init parameters. Decouple from cfg that they are using.
        """
        super().__init__()

        # Vision & Text Encoder
        clip_model = torch.jit.load(clip_weights_path, map_location="cpu").eval()
